...
Over the years, I have taught and assisted in a variety of courses at both undergraduate and graduate levels, spanning GIS, geography, and spatial statistics.  
...
- 🌍 **World Geography** – *Kent State University (Fall 2021)*  
  *Explored cultural, political, and physical landscapes worldwide, encouraging students to think critically about global interconnections.*  

- 🗺️ **Introduction to Geography** – *Kent State University (Spring 2021)*  
  *Covered core geographical concepts, human-environment interactions, and spatial thinking for first-year students.*  
...
- 📊 **Spatial Analysis** – *University of Akron (Spring 2018)*  
  *Supported teaching of spatial statistics, geostatistical methods, and lab-based exercises.*  

- 🗃️ **Introduction to GIS** – *University of Akron (Fall 2017)*  
  *Mentored students in GIS fundamentals, data management, and cartographic production.*  

---

## 🌟 Teaching Philosophy  

I believe learning should be **interactive, collaborative, and applied**. My teaching emphasizes:  

✅ Real-world projects that mirror professional challenges  
✅ Integration of **R** and **open-source tools** for reproducible workflows  
✅ Creativity and critical thinking in solving spatial problems  
✅ Mentorship that empowers students to apply geospatial skills in academia, industry, and policy  
